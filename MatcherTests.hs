...
testVersion = TestLabel "Version" $ TestList
    [ test 0.0     (Desc [v, e] [])                                  "abc1.00def"
    , test 0.75    (Desc [v, e] [])                                  "abc0def"
    , test 0.2     (Desc [v, e] [])                                  "abc1.0.0def"
    , test 0.9     (Desc [v, e] [])                                  "abc99.999.999def"
    , test 1.0     (Desc [v, e] [])                                  "abc0_1def"
    , test 0.25    (Desc [Version "a*(b)+c" "1.00", e] [])           "a*(b)+c1.0def"
    , test 0.75    (Desc [Version "abc" "2.22"] [])                  "abc1.00"
    , test 0.0     (Desc [Version "; " "1.00"] [])                   "; 1.00"
    , test 0.25    (Desc [Version "; " "1.00"] [])                   "; 2.00"
    ] where
        test e d s = (show s ++ show d) ~: e ~=? score d s
        v = Version "abc" "1.00"
        e = Exact "def"
...
testScoreExample = TestLabel "ScoreExample" $ TestList
    [ test   1.25     ps1                      "Mozilla/5.0 (PLAYSTATION 3; 2.00)"
    , test   1.0      ps2                      "Mozilla/5.0 (PLAYSTATION 3; 2.00)"
    , test   1.5      ps1                      "Mozilla/2.0 (PLAYSTATION 3; 4.70)"
    , test   1.25     ps4                      "Mozilla/2.0 (PLAYSTATION 3; 4.70)"
    ] where
        test e d s = (show s ++ show d) ~: e ~=? score d s
        ps1 = Desc [Version "Mozilla/" "", Fuzzy " (", Exact "PLAYSTATION 3", Version "; " "1.00", Fuzzy ")"] []
        ps2 = Desc [Version "Mozilla/" "", Fuzzy " (", Exact "PLAYSTATION 3", Version "; " "2.00", Fuzzy ")"] []
        ps4 = Desc [Version "Mozilla/" "", Fuzzy " (", Exact "PLAYSTATION 3", Version "; " "4.77", Fuzzy ")"] []
