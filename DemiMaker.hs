...
markup wid s = foldr replace s replacements
	where
		...
		replacements = [
				...
				, exact "GameStick"
				, exact "ANTGalio/3.2.0.25.01.devel.46723MU"
				, exact "GV102ZRH"
				, exact "GEEYA"
				, exact "VW11FVRHD"
				, exact "STSDK/sh4;" -- YUCK
				, exact "Hisense"
				...
				, exact "HDR-5100S"
				, exact "hdr1000s"
				, exact "Linux mips; (U; )?HbbTV/1.[12].1 \\(; Freesat"
				, exact "LG UA"
				, exact "hb1000s"
				...
				, exact "Onyx/CelloTV"
				, exact "OUYA"
				, exact "(Linux armv6[lI]; U; )?Panasonic.bd.[0-9]{4}"
				...
				, exact "Presto/2.9.167 Version/11.50" -- YUCK!
				, exact "Viera"
				, exact "SAGEMCOM"
				, exact "HDSP"
				, exact "\\(Linux armv6l ; U; CE-HTML/1.0 NETTV/3.0.1;; en\\)"
				, exact "PHILIPS-AVM-2012"
				, exact "Philips, BDP[0-9]{4}[A-Z]?"
				, exact "Philips, HMP7100"
				, exact "(\\(; )?Philips; ; ; PHILIPSTV; \\) CE-HTML/1.0 NETTV/4.[13].1"
				, exact "PHILIPS_OLS_2010"
				, exact "(Linux mips ?; U; HbbTV/1.1.1 \\(; )?Philips; ; ; ; \\) CE-HTML/1.0 NETTV/4.[01].1;"
				, exact "Philips; ; ; ; \\) CE-HTML/1.0 NETTV/3.2.1;"
				, exact "Philips;;;;\\) CE-HTML/1.0 NETTV/4.0.2"
				, exact "Philips; ; ; ; \\) CE-HTML/1.0 NETTV/4.3.0"
				, exact "Philips;MT55[0-9]{2};"
				, exact "Linux armv7l; U; CE-HTML"
				, exact "Linux mips; U; CE-HTML"
				, exact "Pure-VL61770"
				, exact "DVP-[0-9]{4}EU"
				, exact "RSIW98"
				, exact "RTI95"
				...
				, exact "X1[0-9]"
				, exact "NT14U"
				, exact "Linux armv6l ; U; HbbTV/1.1.1 \\(; ; ; ; ; \\) CE-HTML"
				, exact "AquosTV"
				, exact "Sharp"
				, exact "LE[0-9]{3};"
				...
				, exact "playstation 3; [0-9.]{4,5}"
				, exact "PS3 \\(PlayStation 3\\); [0-9.]{4,5}"
				, exact "\\(PlayStation [0-9]\\) "
				, exact "SCEE/1.0 Nuanti/2.0"
				, exact "SCEE/1.0 ?NuantiMeta/2.0"
				, exact "sony.tv.[0-9]{4}"
				, exact "Tesco"
				...
				, exact "(Linux armv[67]l; U; )?TOSHIBA; BDX2250KB;"
				, exact "Linux (mips|armv7l) ; U; ?avdn/Toshiba.tv.[0-9]{4}"
				...
				, exact "Opera/9.80 \\(Linux mips; U; ; en\\)" -- YUCK
				, exact "GV101YRH"
				, exact "WDSimpleBrowser"
				, exact "Maple[0-9]{4}"
				, exact "Westerndigital/Streamer2010"
				, exact "YouViewHTML"
				, exact "Linux sh4 ?; ? (U; )?HbbTV/1.[12].1 \\(\\+PVR; Loewe; SL[0-9]{3};"
				, exact "\\(Linux_SDK; test\\)Linux_SDK"
				, exact "\\(QtEmbedded; Linux\\)"
			]
		exact s = ("(" ++ s ++ ")", "[+\\1]")
